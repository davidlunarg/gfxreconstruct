...
#ifndef BRIMSTONE_UTIL_VMA_MEMORY_ALLOCATOR_H
#define BRIMSTONE_UTIL_VMA_MEMORY_ALLOCATOR_H
...
class VmaMemoryAllocator : public GraphicsMemoryAllocator
{
public:
    VmaMemoryAllocator(VkPhysicalDevice physical_device, VkDevice device);
...
private:
    ...
    std::unordered_multimap<GraphicsMemory*, VmaAllocation> memory_allocation_map_;
    std::unordered_map<VmaAllocation, VkDeviceSize> memory_offset_map_;
};

BRIMSTONE_END_NAMESPACE(util)
BRIMSTONE_END_NAMESPACE(brimstone)

#endif // BRIMSTONE_UTIL_VMA_MEMORY_ALLOCATOR_H
