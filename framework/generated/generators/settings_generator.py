...
def WriteSourceHeader(file):
    source_header = '/*\n'
    source_header += '** Copyright (c) 2018 Valve Corporation\n'
    source_header += '** Copyright (c) 2018 LunarG, Inc.\n'
    source_header += '**\n'
...
def WriteAndroidEnvVarSettings(file, settings, default_capture_name, prefix):
    env_var_string  = 'const char kDefaultCaptureFileName[] = "/sdcard/%s";\n' % default_capture_name
    env_var_string += '\n'
...
def WriteDesktopEnvVarSettings(file, settings, default_capture_name, prefix):
    env_var_string  = 'const char kDefaultCaptureFileName[] = "%s";\n' % default_capture_name
    env_var_string += '\n'
