...
struct Decoded_VkPhysicalDeviceSeparateDepthStencilLayoutsFeaturesKHR;
struct Decoded_VkAttachmentReferenceStencilLayoutKHR;
struct Decoded_VkAttachmentDescriptionStencilLayoutKHR;

size_t DecodeStruct(const uint8_t* parameter_buffer, size_t buffer_size, Decoded_VkPhysicalDeviceSeparateDepthStencilLayoutsFeaturesKHR* wrapper);
size_t DecodeStruct(const uint8_t* parameter_buffer, size_t buffer_size, Decoded_VkAttachmentReferenceStencilLayoutKHR* wrapper);
size_t DecodeStruct(const uint8_t* parameter_buffer, size_t buffer_size, Decoded_VkAttachmentDescriptionStencilLayoutKHR* wrapper);
