    ...
    const HandlePointerDecoder<VkInstance>&     pInstance)
{
    ...
    *out += "\"name\" : \"pCreateInfo\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pCreateInfo.GetAddress()); // JHI
    *out += "\n";
    outString += "                },\n";
    ...
    *out += "\"name\" : \"pAllocator\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pAllocator.GetAddress()); // JHI
    *out += "\n";
    outString += "                },\n";
    ...
    *out += "\"name\" : \"pInstance\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pInstance.GetAddress()); // KGJ
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const HandlePointerDecoder<VkPhysicalDevice>& pPhysicalDevices)
{
    ...
    *out += "\"name\" : \"pPhysicalDeviceCount\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pPhysicalDeviceCount.GetAddress()); // KGJ
    *out += "\n";
    outString += "                },\n";
    ...
    *out += "\"name\" : \"pPhysicalDevices\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pPhysicalDevices.GetAddress()); // WIS
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkPhysicalDeviceFeatures>& pFeatures)
{
    ...
    *out += "\"name\" : \"pFeatures\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pFeatures.GetAddress()); // JHI
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkFormatProperties>& pFormatProperties)
{
    ...
    *out += "\"name\" : \"pFormatProperties\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pFormatProperties.GetAddress()); // JHI
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkImageFormatProperties>& pImageFormatProperties)
{
    ...
    *out += "\"name\" : \"pImageFormatProperties\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pImageFormatProperties.GetAddress()); // JHI
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkPhysicalDeviceProperties>& pProperties)
{
    ...
    *out += "\"name\" : \"pProperties\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pProperties.GetAddress()); // JHI
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkQueueFamilyProperties>& pQueueFamilyProperties)
{
    ...
    *out += "\"name\" : \"pQueueFamilyPropertyCount\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pQueueFamilyPropertyCount.GetAddress()); // KGJ
    *out += "\n";
    outString += "                },\n";
    ...
    *out += "\"name\" : \"pQueueFamilyProperties\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pQueueFamilyProperties.GetAddress()); // WUS
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkPhysicalDeviceMemoryProperties>& pMemoryProperties)
{
    ...
    *out += "\"name\" : \"pMemoryProperties\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pMemoryProperties.GetAddress()); // JHI
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const HandlePointerDecoder<VkDevice>&       pDevice)
{
    ...
    *out += "\"name\" : \"pDevice\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pDevice.GetAddress()); // KGJ
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const HandlePointerDecoder<VkQueue>&        pQueue)
{
    ...
    *out += "\"name\" : \"pQueue\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pQueue.GetAddress()); // KGJ
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    format::HandleId                            fence)
{
    ...
    *out += "\"name\" : \"pSubmits\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pSubmits.GetAddress()); // WUS
    *out += "\n";
    outString += "                },\n";
    ...
    const HandlePointerDecoder<VkDeviceMemory>& pMemory)
{
    ...
    *out += "\"name\" : \"pAllocateInfo\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pAllocateInfo.GetAddress()); // JHI
    *out += "\n";
    outString += "                },\n";
    ...
    *out += "\"name\" : \"pMemory\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pMemory.GetAddress()); // KGJ
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const PointerDecoder<uint64_t>&             ppData)
{
    ...
    *out += "\"name\" : \"ppData\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, ppData.GetAddress()); // KGJ
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkMappedMemoryRange>& pMemoryRanges)
{
    ...
    *out += "\"name\" : \"pMemoryRanges\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pMemoryRanges.GetAddress()); // WUS
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const PointerDecoder<VkDeviceSize>&         pCommittedMemoryInBytes)
{
    ...
    *out += "\"name\" : \"pCommittedMemoryInBytes\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pCommittedMemoryInBytes.GetAddress()); // KGJ
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkMemoryRequirements>& pMemoryRequirements)
{
    ...
    *out += "\"name\" : \"pMemoryRequirements\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pMemoryRequirements.GetAddress()); // JHI
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkSparseImageMemoryRequirements>& pSparseMemoryRequirements)
{
    ...
    *out += "\"name\" : \"pSparseMemoryRequirementCount\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pSparseMemoryRequirementCount.GetAddress()); // KGJ
    *out += "\n";
    outString += "                },\n";
    ...
    *out += "\"name\" : \"pSparseMemoryRequirements\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pSparseMemoryRequirements.GetAddress()); // WUS
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkSparseImageFormatProperties>& pProperties)
{
    ...
    *out += "\"name\" : \"pPropertyCount\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pPropertyCount.GetAddress()); // KGJ
    *out += "\n";
    outString += "                },\n";
    ...
    *out += "\"name\" : \"pProperties\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pProperties.GetAddress()); // WUS
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    format::HandleId                            fence)
{
    ...
    *out += "\"name\" : \"pBindInfo\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pBindInfo.GetAddress()); // WUS
    *out += "\n";
    outString += "                },\n";
    ...
    const HandlePointerDecoder<VkFence>&        pFence)
{
    ...
    *out += "\"name\" : \"pFence\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pFence.GetAddress()); // KGJ
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const HandlePointerDecoder<VkFence>&        pFences)
{
    ...
    *out += "\"name\" : \"pFences\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pFences.GetAddress()); // WIS
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const HandlePointerDecoder<VkSemaphore>&    pSemaphore)
{
    ...
    *out += "\"name\" : \"pSemaphore\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pSemaphore.GetAddress()); // KGJ
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const HandlePointerDecoder<VkEvent>&        pEvent)
{
    ...
    *out += "\"name\" : \"pEvent\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pEvent.GetAddress()); // KGJ
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const HandlePointerDecoder<VkQueryPool>&    pQueryPool)
{
    ...
    *out += "\"name\" : \"pQueryPool\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pQueryPool.GetAddress()); // KGJ
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    VkQueryResultFlags                          flags)
{
    ...
    *out += "\"name\" : \"pData\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pData.GetAddress()); // WIS
    *out += "\n";
    outString += "                },\n";
    ...
    const HandlePointerDecoder<VkBuffer>&       pBuffer)
{
    ...
    *out += "\"name\" : \"pBuffer\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pBuffer.GetAddress()); // KGJ
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const HandlePointerDecoder<VkBufferView>&   pView)
{
    ...
    *out += "\"name\" : \"pView\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, *(static_cast<uint64_t*>(pView.GetPointer()))); // PWA
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const HandlePointerDecoder<VkImage>&        pImage)
{
    ...
    *out += "\"name\" : \"pImage\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pImage.GetAddress()); // KGJ
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkSubresourceLayout>& pLayout)
{
    ...
    *out += "\"name\" : \"pSubresource\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pSubresource.GetAddress()); // JHI
    *out += "\n";
    outString += "                },\n";
    ...
    *out += "\"name\" : \"pLayout\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pLayout.GetAddress()); // JHI
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const HandlePointerDecoder<VkShaderModule>& pShaderModule)
{
    ...
    *out += "\"name\" : \"pShaderModule\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pShaderModule.GetAddress()); // KGJ
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const HandlePointerDecoder<VkPipelineCache>& pPipelineCache)
{
    ...
    *out += "\"name\" : \"pPipelineCache\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pPipelineCache.GetAddress()); // KGJ
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const PointerDecoder<uint8_t>&              pData)
{
    ...
    *out += "\"name\" : \"pDataSize\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pDataSize.GetAddress()); // KGJ
    *out += "\n";
    outString += "                },\n";
    ...
    const HandlePointerDecoder<VkPipelineCache>& pSrcCaches)
{
    ...
    *out += "\"name\" : \"pSrcCaches\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pSrcCaches.GetAddress()); // WIS
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const HandlePointerDecoder<VkPipeline>&     pPipelines)
{
    ...
    *out += "\"name\" : \"pCreateInfos\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pCreateInfos.GetAddress()); // WUS
    *out += "\n";
    outString += "                },\n";
    ...
    *out += "\"name\" : \"pPipelines\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pPipelines.GetAddress()); // WIS
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const HandlePointerDecoder<VkPipelineLayout>& pPipelineLayout)
{
    ...
    *out += "\"name\" : \"pPipelineLayout\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pPipelineLayout.GetAddress()); // KGJ
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const HandlePointerDecoder<VkSampler>&      pSampler)
{
    ...
    *out += "\"name\" : \"pSampler\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pSampler.GetAddress()); // KGJ
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const HandlePointerDecoder<VkDescriptorSetLayout>& pSetLayout)
{
    ...
    *out += "\"name\" : \"pSetLayout\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pSetLayout.GetAddress()); // KGJ
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const HandlePointerDecoder<VkDescriptorPool>& pDescriptorPool)
{
    ...
    *out += "\"name\" : \"pDescriptorPool\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pDescriptorPool.GetAddress()); // KGJ
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const HandlePointerDecoder<VkDescriptorSet>& pDescriptorSets)
{
    ...
    *out += "\"name\" : \"pDescriptorSets\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pDescriptorSets.GetAddress()); // WIS
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkCopyDescriptorSet>& pDescriptorCopies)
{
    ...
    *out += "\"name\" : \"pDescriptorWrites\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pDescriptorWrites.GetAddress()); // WUS
    *out += "\n";
    outString += "                },\n";
    ...
    *out += "\"name\" : \"pDescriptorCopies\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pDescriptorCopies.GetAddress()); // WUS
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const HandlePointerDecoder<VkFramebuffer>&  pFramebuffer)
{
    ...
    *out += "\"name\" : \"pFramebuffer\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pFramebuffer.GetAddress()); // KGJ
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const HandlePointerDecoder<VkRenderPass>&   pRenderPass)
{
    ...
    *out += "\"name\" : \"pRenderPass\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pRenderPass.GetAddress()); // KGJ
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkExtent2D>& pGranularity)
{
    ...
    *out += "\"name\" : \"pGranularity\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pGranularity.GetAddress()); // JHI
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const HandlePointerDecoder<VkCommandPool>&  pCommandPool)
{
    ...
    *out += "\"name\" : \"pCommandPool\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pCommandPool.GetAddress()); // KGJ
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const HandlePointerDecoder<VkCommandBuffer>& pCommandBuffers)
{
    ...
    *out += "\"name\" : \"pCommandBuffers\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pCommandBuffers.GetAddress()); // WIS
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkCommandBufferBeginInfo>& pBeginInfo)
{
    ...
    *out += "\"name\" : \"pBeginInfo\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pBeginInfo.GetAddress()); // JHI
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkViewport>& pViewports)
{
    ...
    *out += "\"name\" : \"pViewports\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pViewports.GetAddress()); // WUS
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkRect2D>& pScissors)
{
    ...
    *out += "\"name\" : \"pScissors\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pScissors.GetAddress()); // WUS
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const PointerDecoder<uint32_t>&             pDynamicOffsets)
{
    ...
    *out += "\"name\" : \"pDynamicOffsets\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pDynamicOffsets.GetAddress()); // WIS
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const PointerDecoder<VkDeviceSize>&         pOffsets)
{
    ...
    *out += "\"name\" : \"pBuffers\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pBuffers.GetAddress()); // WIS
    *out += "\n";
    outString += "                },\n";
    ...
    *out += "\"name\" : \"pOffsets\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pOffsets.GetAddress()); // WIS
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkBufferCopy>& pRegions)
{
    ...
    *out += "\"name\" : \"pRegions\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pRegions.GetAddress()); // WUS
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkImageSubresourceRange>& pRanges)
{
    ...
    *out += "\"name\" : \"pColor\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pColor.GetAddress()); // JHI
    *out += "\n";
    outString += "                },\n";
    ...
    *out += "\"name\" : \"pRanges\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pRanges.GetAddress()); // WUS
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkImageSubresourceRange>& pRanges)
{
    ...
    *out += "\"name\" : \"pDepthStencil\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pDepthStencil.GetAddress()); // JHI
    *out += "\n";
    outString += "                },\n";
    ...
    const StructPointerDecoder<Decoded_VkClearRect>& pRects)
{
    ...
    *out += "\"name\" : \"pAttachments\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pAttachments.GetAddress()); // WUS
    *out += "\n";
    outString += "                },\n";
    ...
    *out += "\"name\" : \"pRects\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pRects.GetAddress()); // WUS
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkImageMemoryBarrier>& pImageMemoryBarriers)
{
    ...
    *out += "\"name\" : \"pEvents\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pEvents.GetAddress()); // WIS
    *out += "\n";
    outString += "                },\n";
    ...
    *out += "\"name\" : \"pMemoryBarriers\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pMemoryBarriers.GetAddress()); // WUS
    *out += "\n";
    outString += "                },\n";
    ...
    *out += "\"name\" : \"pBufferMemoryBarriers\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pBufferMemoryBarriers.GetAddress()); // WUS
    *out += "\n";
    outString += "                },\n";
    ...
    *out += "\"name\" : \"pImageMemoryBarriers\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pImageMemoryBarriers.GetAddress()); // WUS
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const PointerDecoder<uint8_t>&              pValues)
{
    ...
    *out += "\"name\" : \"pValues\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pValues.GetAddress()); // WIS
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    VkSubpassContents                           contents)
{
    ...
    *out += "\"name\" : \"pRenderPassBegin\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pRenderPassBegin.GetAddress()); // JHI
    *out += "\n";
    outString += "                },\n";
    ...
    const StructPointerDecoder<Decoded_VkBindBufferMemoryInfo>& pBindInfos)
{
    ...
    *out += "\"name\" : \"pBindInfos\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pBindInfos.GetAddress()); // WUS
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const PointerDecoder<VkPeerMemoryFeatureFlags>& pPeerMemoryFeatures)
{
    ...
    *out += "\"name\" : \"pPeerMemoryFeatures\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pPeerMemoryFeatures.GetAddress()); // KGJ
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkPhysicalDeviceGroupProperties>& pPhysicalDeviceGroupProperties)
{
    ...
    *out += "\"name\" : \"pPhysicalDeviceGroupCount\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pPhysicalDeviceGroupCount.GetAddress()); // KGJ
    *out += "\n";
    outString += "                },\n";
    ...
    *out += "\"name\" : \"pPhysicalDeviceGroupProperties\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pPhysicalDeviceGroupProperties.GetAddress()); // WUS
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkMemoryRequirements2>& pMemoryRequirements)
{
    ...
    *out += "\"name\" : \"pInfo\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pInfo.GetAddress()); // JHI
    *out += "\n";
    outString += "                },\n";
    ...
    const StructPointerDecoder<Decoded_VkImageFormatProperties2>& pImageFormatProperties)
{
    ...
    *out += "\"name\" : \"pImageFormatInfo\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pImageFormatInfo.GetAddress()); // JHI
    *out += "\n";
    outString += "                },\n";
    ...
    const StructPointerDecoder<Decoded_VkSparseImageFormatProperties2>& pProperties)
{
    ...
    *out += "\"name\" : \"pFormatInfo\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pFormatInfo.GetAddress()); // JHI
    *out += "\n";
    outString += "                },\n";
    ...
    const HandlePointerDecoder<VkQueue>&        pQueue)
{
    ...
    *out += "\"name\" : \"pQueueInfo\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pQueueInfo.GetAddress()); // JHI
    *out += "\n";
    outString += "                },\n";
    ...
    const HandlePointerDecoder<VkSamplerYcbcrConversion>& pYcbcrConversion)
{
    ...
    *out += "\"name\" : \"pYcbcrConversion\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pYcbcrConversion.GetAddress()); // KGJ
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const HandlePointerDecoder<VkDescriptorUpdateTemplate>& pDescriptorUpdateTemplate)
{
    ...
    *out += "\"name\" : \"pDescriptorUpdateTemplate\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pDescriptorUpdateTemplate.GetAddress()); // KGJ
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkExternalBufferProperties>& pExternalBufferProperties)
{
    ...
    *out += "\"name\" : \"pExternalBufferInfo\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pExternalBufferInfo.GetAddress()); // JHI
    *out += "\n";
    outString += "                },\n";
    ...
    *out += "\"name\" : \"pExternalBufferProperties\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pExternalBufferProperties.GetAddress()); // JHI
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkExternalFenceProperties>& pExternalFenceProperties)
{
    ...
    *out += "\"name\" : \"pExternalFenceInfo\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pExternalFenceInfo.GetAddress()); // JHI
    *out += "\n";
    outString += "                },\n";
    ...
    *out += "\"name\" : \"pExternalFenceProperties\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pExternalFenceProperties.GetAddress()); // JHI
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkExternalSemaphoreProperties>& pExternalSemaphoreProperties)
{
    ...
    *out += "\"name\" : \"pExternalSemaphoreInfo\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pExternalSemaphoreInfo.GetAddress()); // JHI
    *out += "\n";
    outString += "                },\n";
    ...
    *out += "\"name\" : \"pExternalSemaphoreProperties\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pExternalSemaphoreProperties.GetAddress()); // JHI
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkDescriptorSetLayoutSupport>& pSupport)
{
    ...
    *out += "\"name\" : \"pSupport\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pSupport.GetAddress()); // JHI
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const PointerDecoder<VkBool32>&             pSupported)
{
    ...
    *out += "\"name\" : \"pSupported\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pSupported.GetAddress()); // KGJ
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkSurfaceCapabilitiesKHR>& pSurfaceCapabilities)
{
    ...
    *out += "\"name\" : \"pSurfaceCapabilities\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pSurfaceCapabilities.GetAddress()); // JHI
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkSurfaceFormatKHR>& pSurfaceFormats)
{
    ...
    *out += "\"name\" : \"pSurfaceFormatCount\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pSurfaceFormatCount.GetAddress()); // KGJ
    *out += "\n";
    outString += "                },\n";
    ...
    *out += "\"name\" : \"pSurfaceFormats\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pSurfaceFormats.GetAddress()); // WUS
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const PointerDecoder<VkPresentModeKHR>&     pPresentModes)
{
    ...
    *out += "\"name\" : \"pPresentModeCount\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pPresentModeCount.GetAddress()); // KGJ
    *out += "\n";
    outString += "                },\n";
    ...
    *out += "\"name\" : \"pPresentModes\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pPresentModes.GetAddress()); // WIS
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const HandlePointerDecoder<VkSwapchainKHR>& pSwapchain)
{
    ...
    *out += "\"name\" : \"pSwapchain\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pSwapchain.GetAddress()); // KGJ
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const HandlePointerDecoder<VkImage>&        pSwapchainImages)
{
    ...
    *out += "\"name\" : \"pSwapchainImageCount\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pSwapchainImageCount.GetAddress()); // KGJ
    *out += "\n";
    outString += "                },\n";
    ...
    *out += "\"name\" : \"pSwapchainImages\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pSwapchainImages.GetAddress()); // WIS
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const PointerDecoder<uint32_t>&             pImageIndex)
{
    ...
    *out += "\"name\" : \"pImageIndex\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pImageIndex.GetAddress()); // KGJ
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkPresentInfoKHR>& pPresentInfo)
{
    ...
    *out += "\"name\" : \"pPresentInfo\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pPresentInfo.GetAddress()); // JHI
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkDeviceGroupPresentCapabilitiesKHR>& pDeviceGroupPresentCapabilities)
{
    ...
    *out += "\"name\" : \"pDeviceGroupPresentCapabilities\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pDeviceGroupPresentCapabilities.GetAddress()); // JHI
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const PointerDecoder<VkDeviceGroupPresentModeFlagsKHR>& pModes)
{
    ...
    *out += "\"name\" : \"pModes\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pModes.GetAddress()); // KGJ
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkRect2D>& pRects)
{
    ...
    *out += "\"name\" : \"pRectCount\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pRectCount.GetAddress()); // KGJ
    *out += "\n";
    outString += "                },\n";
    ...
    const PointerDecoder<uint32_t>&             pImageIndex)
{
    ...
    *out += "\"name\" : \"pAcquireInfo\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pAcquireInfo.GetAddress()); // JHI
    *out += "\n";
    outString += "                },\n";
    ...
    const HandlePointerDecoder<VkDisplayKHR>&   pDisplays)
{
    ...
    *out += "\"name\" : \"pDisplayCount\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pDisplayCount.GetAddress()); // KGJ
    *out += "\n";
    outString += "                },\n";
    ...
    *out += "\"name\" : \"pDisplays\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pDisplays.GetAddress()); // WIS
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const HandlePointerDecoder<VkDisplayModeKHR>& pMode)
{
    ...
    *out += "\"name\" : \"pMode\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pMode.GetAddress()); // KGJ
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkDisplayPlaneCapabilitiesKHR>& pCapabilities)
{
    ...
    *out += "\"name\" : \"pCapabilities\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pCapabilities.GetAddress()); // JHI
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const HandlePointerDecoder<VkSurfaceKHR>&   pSurface)
{
    ...
    *out += "\"name\" : \"pSurface\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pSurface.GetAddress()); // KGJ
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const HandlePointerDecoder<VkSwapchainKHR>& pSwapchains)
{
    ...
    *out += "\"name\" : \"pSwapchains\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pSwapchains.GetAddress()); // WIS
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    uint32_t                                    visual_id)
{
    ...
    *out += "\"name\" : \"connection\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, connection); // PWR
    *out += "\n";
    outString += "                },\n";
    ...
    uint64_t                                    display)
{
    ...
    *out += "\"name\" : \"display\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, display); // PWR
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const PointerDecoder<uint64_t>&             pHandle)
{
    ...
    *out += "\"name\" : \"pGetWin32HandleInfo\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pGetWin32HandleInfo.GetAddress()); // JHI
    *out += "\n";
    outString += "                },\n";
    ...
    *out += "\"name\" : \"pHandle\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pHandle.GetAddress()); // KGJ
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkMemoryWin32HandlePropertiesKHR>& pMemoryWin32HandleProperties)
{
    ...
    *out += "\"name\" : \"handle\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, handle); // PWR
    *out += "\n";
    outString += "                },\n";
    ...
    *out += "\"name\" : \"pMemoryWin32HandleProperties\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pMemoryWin32HandleProperties.GetAddress()); // JHI
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const PointerDecoder<int>&                  pFd)
{
    ...
    *out += "\"name\" : \"pGetFdInfo\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pGetFdInfo.GetAddress()); // JHI
    *out += "\n";
    outString += "                },\n";
    ...
    *out += "\"name\" : \"pFd\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pFd.GetAddress()); // KGJ
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkMemoryFdPropertiesKHR>& pMemoryFdProperties)
{
    ...
    *out += "\"name\" : \"pMemoryFdProperties\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pMemoryFdProperties.GetAddress()); // JHI
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkImportSemaphoreWin32HandleInfoKHR>& pImportSemaphoreWin32HandleInfo)
{
    ...
    *out += "\"name\" : \"pImportSemaphoreWin32HandleInfo\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pImportSemaphoreWin32HandleInfo.GetAddress()); // JHI
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkImportSemaphoreFdInfoKHR>& pImportSemaphoreFdInfo)
{
    ...
    *out += "\"name\" : \"pImportSemaphoreFdInfo\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pImportSemaphoreFdInfo.GetAddress()); // JHI
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkSubpassBeginInfoKHR>& pSubpassBeginInfo)
{
    ...
    *out += "\"name\" : \"pSubpassBeginInfo\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pSubpassBeginInfo.GetAddress()); // JHI
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkSubpassEndInfoKHR>& pSubpassEndInfo)
{
    ...
    *out += "\"name\" : \"pSubpassEndInfo\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pSubpassEndInfo.GetAddress()); // JHI
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkImportFenceWin32HandleInfoKHR>& pImportFenceWin32HandleInfo)
{
    ...
    *out += "\"name\" : \"pImportFenceWin32HandleInfo\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pImportFenceWin32HandleInfo.GetAddress()); // JHI
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkImportFenceFdInfoKHR>& pImportFenceFdInfo)
{
    ...
    *out += "\"name\" : \"pImportFenceFdInfo\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pImportFenceFdInfo.GetAddress()); // JHI
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkSurfaceCapabilities2KHR>& pSurfaceCapabilities)
{
    ...
    *out += "\"name\" : \"pSurfaceInfo\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pSurfaceInfo.GetAddress()); // JHI
    *out += "\n";
    outString += "                },\n";
    ...
    const StructPointerDecoder<Decoded_VkDisplayPlaneCapabilities2KHR>& pCapabilities)
{
    ...
    *out += "\"name\" : \"pDisplayPlaneInfo\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pDisplayPlaneInfo.GetAddress()); // JHI
    *out += "\n";
    outString += "                },\n";
    ...
    const PointerDecoder<uint64_t>&             pValue)
{
    ...
    *out += "\"name\" : \"pValue\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pValue.GetAddress()); // KGJ
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    uint64_t                                    timeout)
{
    ...
    *out += "\"name\" : \"pWaitInfo\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pWaitInfo.GetAddress()); // JHI
    *out += "\n";
    outString += "                },\n";
    ...
    const StructPointerDecoder<Decoded_VkSemaphoreSignalInfoKHR>& pSignalInfo)
{
    ...
    *out += "\"name\" : \"pSignalInfo\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pSignalInfo.GetAddress()); // JHI
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkPipelineExecutablePropertiesKHR>& pProperties)
{
    ...
    *out += "\"name\" : \"pPipelineInfo\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pPipelineInfo.GetAddress()); // JHI
    *out += "\n";
    outString += "                },\n";
    ...
    *out += "\"name\" : \"pExecutableCount\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pExecutableCount.GetAddress()); // KGJ
    *out += "\n";
    outString += "                },\n";
    ...
    const StructPointerDecoder<Decoded_VkPipelineExecutableStatisticKHR>& pStatistics)
{
    ...
    *out += "\"name\" : \"pExecutableInfo\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pExecutableInfo.GetAddress()); // JHI
    *out += "\n";
    outString += "                },\n";
    ...
    *out += "\"name\" : \"pStatisticCount\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pStatisticCount.GetAddress()); // KGJ
    *out += "\n";
    outString += "                },\n";
    ...
    *out += "\"name\" : \"pStatistics\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pStatistics.GetAddress()); // WUS
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkPipelineExecutableInternalRepresentationKHR>& pInternalRepresentations)
{
    ...
    *out += "\"name\" : \"pInternalRepresentationCount\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pInternalRepresentationCount.GetAddress()); // KGJ
    *out += "\n";
    outString += "                },\n";
    ...
    *out += "\"name\" : \"pInternalRepresentations\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pInternalRepresentations.GetAddress()); // WUS
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const HandlePointerDecoder<VkDebugReportCallbackEXT>& pCallback)
{
    ...
    *out += "\"name\" : \"pCallback\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pCallback.GetAddress()); // KGJ
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StringDecoder&                        pMessage)
{
    ...
    *out += "\"name\" : \"pLayerPrefix\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pLayerPrefix.GetAddress()); // KGJ
    *out += "\n";
    outString += "                },\n";
    ...
    *out += "\"name\" : \"pMessage\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pMessage.GetAddress()); // KGJ
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkDebugMarkerObjectTagInfoEXT>& pTagInfo)
{
    ...
    *out += "\"name\" : \"pTagInfo\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pTagInfo.GetAddress()); // JHI
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkDebugMarkerObjectNameInfoEXT>& pNameInfo)
{
    ...
    *out += "\"name\" : \"pNameInfo\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pNameInfo.GetAddress()); // JHI
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkDebugMarkerMarkerInfoEXT>& pMarkerInfo)
{
    ...
    *out += "\"name\" : \"pMarkerInfo\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pMarkerInfo.GetAddress()); // JHI
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const PointerDecoder<VkDeviceSize>&         pSizes)
{
    ...
    *out += "\"name\" : \"pSizes\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pSizes.GetAddress()); // WIS
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const PointerDecoder<VkDeviceSize>&         pCounterBufferOffsets)
{
    ...
    *out += "\"name\" : \"pCounterBuffers\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pCounterBuffers.GetAddress()); // WIS
    *out += "\n";
    outString += "                },\n";
    ...
    *out += "\"name\" : \"pCounterBufferOffsets\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pCounterBufferOffsets.GetAddress()); // WIS
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const PointerDecoder<uint8_t>&              pInfo)
{
    ...
    *out += "\"name\" : \"pInfoSize\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pInfoSize.GetAddress()); // KGJ
    *out += "\n";
    outString += "                },\n";
    ...
    *out += "\"name\" : \"pInfo\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pInfo.GetAddress()); // WIS
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkExternalImageFormatPropertiesNV>& pExternalImageFormatProperties)
{
    ...
    *out += "\"name\" : \"pExternalImageFormatProperties\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pExternalImageFormatProperties.GetAddress()); // JHI
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkConditionalRenderingBeginInfoEXT>& pConditionalRenderingBegin)
{
    ...
    *out += "\"name\" : \"pConditionalRenderingBegin\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pConditionalRenderingBegin.GetAddress()); // JHI
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkCmdProcessCommandsInfoNVX>& pProcessCommandsInfo)
{
    ...
    *out += "\"name\" : \"pProcessCommandsInfo\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pProcessCommandsInfo.GetAddress()); // JHI
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkCmdReserveSpaceForCommandsInfoNVX>& pReserveSpaceInfo)
{
    ...
    *out += "\"name\" : \"pReserveSpaceInfo\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pReserveSpaceInfo.GetAddress()); // JHI
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const HandlePointerDecoder<VkIndirectCommandsLayoutNVX>& pIndirectCommandsLayout)
{
    ...
    *out += "\"name\" : \"pIndirectCommandsLayout\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pIndirectCommandsLayout.GetAddress()); // KGJ
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const HandlePointerDecoder<VkObjectTableNVX>& pObjectTable)
{
    ...
    *out += "\"name\" : \"pObjectTable\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pObjectTable.GetAddress()); // KGJ
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const PointerDecoder<uint32_t>&             pObjectIndices)
{
    ...
    *out += "\"name\" : \"pObjectEntryTypes\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pObjectEntryTypes.GetAddress()); // WIS
    *out += "\n";
    outString += "                },\n";
    ...
    *out += "\"name\" : \"pObjectIndices\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pObjectIndices.GetAddress()); // WIS
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkDeviceGeneratedCommandsLimitsNVX>& pLimits)
{
    ...
    *out += "\"name\" : \"pLimits\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pLimits.GetAddress()); // JHI
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkViewportWScalingNV>& pViewportWScalings)
{
    ...
    *out += "\"name\" : \"pViewportWScalings\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pViewportWScalings.GetAddress()); // WUS
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const HandlePointerDecoder<VkDisplayKHR>&   pDisplay)
{
    ...
    *out += "\"name\" : \"pDisplay\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pDisplay.GetAddress()); // KGJ
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkDisplayPowerInfoEXT>& pDisplayPowerInfo)
{
    ...
    *out += "\"name\" : \"pDisplayPowerInfo\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pDisplayPowerInfo.GetAddress()); // JHI
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const HandlePointerDecoder<VkFence>&        pFence)
{
    ...
    *out += "\"name\" : \"pDeviceEventInfo\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pDeviceEventInfo.GetAddress()); // JHI
    *out += "\n";
    outString += "                },\n";
    ...
    const HandlePointerDecoder<VkFence>&        pFence)
{
    ...
    *out += "\"name\" : \"pDisplayEventInfo\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pDisplayEventInfo.GetAddress()); // JHI
    *out += "\n";
    outString += "                },\n";
    ...
    const PointerDecoder<uint64_t>&             pCounterValue)
{
    ...
    *out += "\"name\" : \"pCounterValue\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pCounterValue.GetAddress()); // KGJ
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkRefreshCycleDurationGOOGLE>& pDisplayTimingProperties)
{
    ...
    *out += "\"name\" : \"pDisplayTimingProperties\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pDisplayTimingProperties.GetAddress()); // JHI
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkPastPresentationTimingGOOGLE>& pPresentationTimings)
{
    ...
    *out += "\"name\" : \"pPresentationTimingCount\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pPresentationTimingCount.GetAddress()); // KGJ
    *out += "\n";
    outString += "                },\n";
    ...
    *out += "\"name\" : \"pPresentationTimings\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pPresentationTimings.GetAddress()); // WUS
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkRect2D>& pDiscardRectangles)
{
    ...
    *out += "\"name\" : \"pDiscardRectangles\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pDiscardRectangles.GetAddress()); // WUS
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkHdrMetadataEXT>& pMetadata)
{
    ...
    *out += "\"name\" : \"pMetadata\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pMetadata.GetAddress()); // WUS
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkDebugUtilsLabelEXT>& pLabelInfo)
{
    ...
    *out += "\"name\" : \"pLabelInfo\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pLabelInfo.GetAddress()); // JHI
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const HandlePointerDecoder<VkDebugUtilsMessengerEXT>& pMessenger)
{
    ...
    *out += "\"name\" : \"pMessenger\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pMessenger.GetAddress()); // KGJ
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkDebugUtilsMessengerCallbackDataEXT>& pCallbackData)
{
    ...
    *out += "\"name\" : \"pCallbackData\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pCallbackData.GetAddress()); // JHI
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkAndroidHardwareBufferPropertiesANDROID>& pProperties)
{
    ...
    *out += "\"name\" : \"buffer\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, buffer); // PWR
    *out += "\n";
    outString += "                },\n";
    ...
    const StructPointerDecoder<Decoded_VkSampleLocationsInfoEXT>& pSampleLocationsInfo)
{
    ...
    *out += "\"name\" : \"pSampleLocationsInfo\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pSampleLocationsInfo.GetAddress()); // JHI
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkMultisamplePropertiesEXT>& pMultisampleProperties)
{
    ...
    *out += "\"name\" : \"pMultisampleProperties\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pMultisampleProperties.GetAddress()); // JHI
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const HandlePointerDecoder<VkValidationCacheEXT>& pValidationCache)
{
    ...
    *out += "\"name\" : \"pValidationCache\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pValidationCache.GetAddress()); // KGJ
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkShadingRatePaletteNV>& pShadingRatePalettes)
{
    ...
    *out += "\"name\" : \"pShadingRatePalettes\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pShadingRatePalettes.GetAddress()); // WUS
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkCoarseSampleOrderCustomNV>& pCustomSampleOrders)
{
    ...
    *out += "\"name\" : \"pCustomSampleOrders\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pCustomSampleOrders.GetAddress()); // WUS
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const HandlePointerDecoder<VkAccelerationStructureNV>& pAccelerationStructure)
{
    ...
    *out += "\"name\" : \"pAccelerationStructure\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pAccelerationStructure.GetAddress()); // KGJ
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    uint32_t                                    firstQuery)
{
    ...
    *out += "\"name\" : \"pAccelerationStructures\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pAccelerationStructures.GetAddress()); // WIS
    *out += "\n";
    outString += "                },\n";
    ...
    const StructPointerDecoder<Decoded_VkMemoryHostPointerPropertiesEXT>& pMemoryHostPointerProperties)
{
    ...
    *out += "\"name\" : \"pHostPointer\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pHostPointer); // PWR
    *out += "\n";
    outString += "                },\n";
    ...
    *out += "\"name\" : \"pMemoryHostPointerProperties\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pMemoryHostPointerProperties.GetAddress()); // JHI
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const PointerDecoder<VkTimeDomainEXT>&      pTimeDomains)
{
    ...
    *out += "\"name\" : \"pTimeDomainCount\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pTimeDomainCount.GetAddress()); // KGJ
    *out += "\n";
    outString += "                },\n";
    ...
    *out += "\"name\" : \"pTimeDomains\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pTimeDomains.GetAddress()); // WIS
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const PointerDecoder<uint64_t>&             pMaxDeviation)
{
    ...
    *out += "\"name\" : \"pTimestampInfos\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pTimestampInfos.GetAddress()); // WUS
    *out += "\n";
    outString += "                },\n";
    ...
    *out += "\"name\" : \"pTimestamps\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pTimestamps.GetAddress()); // WIS
    *out += "\n";
    outString += "                },\n";
    ...
    *out += "\"name\" : \"pMaxDeviation\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pMaxDeviation.GetAddress()); // KGJ
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkRect2D>& pExclusiveScissors)
{
    ...
    *out += "\"name\" : \"pExclusiveScissors\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pExclusiveScissors.GetAddress()); // WUS
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    uint64_t                                    pCheckpointMarker)
{
    ...
    *out += "\"name\" : \"pCheckpointMarker\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pCheckpointMarker); // PWR
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkCheckpointDataNV>& pCheckpointData)
{
    ...
    *out += "\"name\" : \"pCheckpointDataCount\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pCheckpointDataCount.GetAddress()); // KGJ
    *out += "\n";
    outString += "                },\n";
    ...
    *out += "\"name\" : \"pCheckpointData\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pCheckpointData.GetAddress()); // WUS
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkInitializePerformanceApiInfoINTEL>& pInitializeInfo)
{
    ...
    *out += "\"name\" : \"pInitializeInfo\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pInitializeInfo.GetAddress()); // JHI
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkPerformanceOverrideInfoINTEL>& pOverrideInfo)
{
    ...
    *out += "\"name\" : \"pOverrideInfo\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pOverrideInfo.GetAddress()); // JHI
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const HandlePointerDecoder<VkPerformanceConfigurationINTEL>& pConfiguration)
{
    ...
    *out += "\"name\" : \"pConfiguration\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pConfiguration.GetAddress()); // KGJ
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkPerformanceValueINTEL>& pValue)
{
    ...
    *out += "\"name\" : \"pValue\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pValue.GetAddress()); // JHI
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
    ...
    const StructPointerDecoder<Decoded_VkFramebufferMixedSamplesCombinationNV>& pCombinations)
{
    ...
    *out += "\"name\" : \"pCombinationCount\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pCombinationCount.GetAddress()); // KGJ
    *out += "\n";
    outString += "                },\n";
    ...
    *out += "\"name\" : \"pCombinations\",\n";
    IndentSpacesJson(out, indent);
    *out += "\"address\" : \"";
    AddrToStringJson(out, pCombinations.GetAddress()); // WUS
    *out += "\n";
    outString += "                }\n";
    fprintf(GetFile(), "%s", outString.c_str());
