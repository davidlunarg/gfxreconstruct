...
Capture File Timestamp | GFXRECON_CAPTURE_FILE_NAME_TIMESTAMP | BOOL | Add a timestamp to the capture file name as described by [Filename Timestamp](#filename-timestamp).  Default is: `true`
...
### Filename Timestamp
When capture file name timestamp is enabled, a timestamp with an
